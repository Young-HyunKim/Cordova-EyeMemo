...
$(document).ready(function () {
    ...
    createPrivateTable();
    SelectSubjectList();
    setInterval(SelectSubjectList, 60*1000);
    setInterval(C_selectSuject, 1000);
    C_selectSuject();
});

var set_Subject = setInterval(SelectSubjectList, 60*1000);
...
function set_Color(CDES) {
    switch (CDES) {
        ...
        case 1: Color_Code = '#08bfc4';
            break;

        case 2: Color_Code = '#53cbf3';
            break;

        case 3: Color_Code = '#4aa0f6';
            break;

        case 4: Color_Code = '#8a75f4';
            break;

        case 5: Color_Code = '#9763ff';
            break;
